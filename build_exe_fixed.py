...
print("打包完成！")
print(f"輸出目錄: {os.path.join(os.getcwd(), 'dist', 'YouTube下載器v1.51')}")

# 添加額外的檔案到輸出目錄
output_dir = os.path.join(os.getcwd(), 'dist', 'YouTube下載器v1.51')
...
with open(os.path.join(output_dir, '啟動下載器.bat'), 'w', encoding='utf-8') as f:
    f.write('@echo off\n')
    f.write('echo 正在啟動 YouTube 下載器 v1.51...\n')
    f.write('start "" "YouTube下載器v1.51.exe"\n')
print("已創建啟動腳本")
